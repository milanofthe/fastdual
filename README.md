...
|-----------|------|-------|----------|
| Scalar add | 120 ns | 95 ns | 1.3x |
| Scalar mul | 122 ns | 98 ns | 1.3x |
| Scalar pow | 165 ns | 121 ns | 1.4x |
| sin | 140 ns | 117 ns | 1.2x |
| exp | 149 ns | 120 ns | 1.2x |
| log | 137 ns | 112 ns | 1.2x |
...
|-----------|-----------|-------|----------|
| Scalar add | 91 ns | 95 ns | 1.0x |
| Scalar mul | 90 ns | 98 ns | 0.9x |
| sin | 103 ns | 117 ns | 0.9x |
| exp | 100 ns | 120 ns | 0.8x |
...
|-----------|---|---|---|
| Jacobian 10x10 | 20.4 us | 80.8 us | **4.0x faster** |
| Jacobian 20x20 | 45.9 us | 237.1 us | **5.2x faster** |
...
| Benchmark | fastdual | fin. diff. | speedup |
|-----------|---|---|---|
| Hessian 5x5 | 14.0 us | 185.9 us | **13.3x faster** |
| Hessian 10x10 | 70.3 us | 1.0 ms | **14.3x faster** |
| Hessian 20x20 | 466.1 us | 6.3 ms | **13.5x faster** |
<!-- BENCH:HESSIAN:END -->
...
|------|-----------------|---------------------|-------|
| 5 variables | 11.4 us | 14.0 us | 1.2x |
| 10 variables | 15.1 us | 70.3 us | 4.7x |
| 20 variables | 22.7 us | 466.1 us | 20.5x |
